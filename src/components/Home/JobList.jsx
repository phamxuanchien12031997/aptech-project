...
// Dữ liệu giả danh sách việc làm
const mockJobs = [
    {
        id: 1,
...
// Chỉ lấy 3 việc đầu để hiển thị ở mục "Việc làm hấp dẫn"
const featuredJobs = [];
for (let i = 0; i < 3; i++) {
...
//Tiêu đề section với nút "Xem tất cả"
