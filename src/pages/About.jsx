...
// ─────────────────────────────────────────────
// PAGE: AboutPage
// Static "About us" content for the landing page.
// ─────────────────────────────────────────────
...
const AboutPage = () => {
    ...
    const values = [
        { icon: '🤝', title: 'Kết nối tin cậy', desc: 'Chúng tôi kết nối người tìm việc với nhà tuyển dụng uy tín một cách minh bạch và nhanh chóng.' },
        { icon: '🔒', title: 'Bảo mật thông tin', desc: 'Thông tin cá nhân và hồ sơ của bạn được bảo vệ theo tiêu chuẩn bảo mật cao nhất.' },
        { icon: '🚀', title: 'Đổi mới liên tục', desc: 'Chúng tôi không ngừng cải tiến nền tảng để mang lại trải nghiệm tốt nhất cho người dùng.' },
        { icon: '🌏', title: 'Phủ sóng toàn quốc', desc: 'Từ Hà Nội đến TP. Hồ Chí Minh và hơn 60 tỉnh thành — JobHot hiện diện khắp Việt Nam.' },
    ];

    const team = [
        { name: 'Nguyễn Minh Khoa', role: 'CEO & Founder', emoji: '👨‍💼' },
        { name: 'Trần Thị Lan', role: 'CTO', emoji: '👩‍💻' },
        { name: 'Phạm Văn Đức', role: 'Head of Product', emoji: '👨‍🎨' },
        { name: 'Lê Thị Thu', role: 'Head of Marketing', emoji: '👩‍📣' },
    ];
        ...
        <div className="flex flex-col min-h-screen bg-gray-50">
            ...
            <div className="bg-linear-to-r from-purple-700 to-purple-500 text-white py-16 px-4 text-center">
                ...
                <p className="text-purple-200 text-base max-w-2xl mx-auto">
                    Nền tảng tuyển dụng hàng đầu Việt Nam — kết nối tài năng với cơ hội
                </p>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-4 py-12 w-full">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8 text-center">
                    ...
                    <p className="text-gray-500 text-sm leading-relaxed max-w-3xl mx-auto">
                        JobHot được thành lập với mục tiêu đơn giản: <strong className="text-purple-700">giúp mỗi người Việt Nam tìm được công việc phù hợp</strong> và giúp mỗi doanh nghiệp tuyển được nhân tài xứng đáng — nhanh chóng, dễ dàng, minh bạch.
                    </p>
                </div>
                ...
                <div className="bg-linear-to-r from-purple-600 to-purple-500 rounded-2xl p-8 text-center text-white">
                    ...
                    <p className="text-purple-200 text-sm mb-5">Đăng ký miễn phí và khám phá hàng ngàn cơ hội việc làm</p>
                    <div className="flex gap-3 justify-center flex-wrap">
                        <Link to="/register" className="px-6 py-2.5 bg-white text-purple-700 font-semibold rounded-lg text-sm hover:bg-purple-50 transition-colors no-underline">
                            Đăng ký ngay
                        </Link>
                        <Link to="/contact" className="px-6 py-2.5 border border-white/40 text-white font-semibold rounded-lg text-sm hover:bg-white/10 transition-colors no-underline">
                            Liên hệ
                        </Link>
                    </div>
                </div>
